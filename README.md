...
**Languages**
`Java` `JavaScript` `TypeScript` `PHP` `C#` `Swift` `Kotlin` `Ruby`

**Frameworks**
`Spring` `Laravel` `React` `Angular` `Vue.js` `.NET`
...
- **Email:** huzeir2k@gmail.com
- **LinkedIn:** [huzeir-kurpejovic](https://www.linkedin.com/in/huzeir-kurpejovic-0ba057192/)
- **Portfolio:** [huzeir2k.github.io](http://huzeir2k.github.io)
